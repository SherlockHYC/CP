...
const Card card_database[] = {
    // Basic Cards (Cost is for buying, playing them gives energy)
    ...
    // Skill Cards (Cost is now for playing the card)
    ...
    DEF_CARD(504, "[Alice] Mad Tea Party", SKILL, 1, 0, 0), // Alice's skill is free
    DEF_CARD(505, "[Mulan] Chi Slash", SKILL, 1, 3, 2),
    DEF_CARD(506, "[Kaguya] Five Problems", SKILL, 1, 0, 1),
    DEF_CARD(507, "[Mermaid] Bubble Song", SKILL, 1, 0, 0), // Mermaid's skill is free
